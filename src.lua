...
if _G.NEXUS_Hub_Hub_Series_R then
	if not game:IsLoaded() then repeat game.Loaded:Wait() until game:IsLoaded() end
	...
	if getgenv().Deleted_Ui then
		...
		-- NEXUS_Hub
		local NEXUS__Hub = Instance.new("ScreenGui")
		NEXUS_Hub_Hub.Name = "Switch Hub"
		NEXUS_Hub.Parent = game:GetService("CoreGui")
		NEXUS_Hub.Enabled = false
		...
		F_Level.Name = "Level"
		F_Level.Parent = game:GetService("CoreGui")["NEXUS Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["NEXUS Hub"].Level
		game:GetService("CoreGui")["NEXUS Hub"].Level.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["NEXUS Hub"].Level.Fragments.Text = "NEXUSh Hub"
		game:GetService("CoreGui")["NEXUS Hub"].Level.Fragments.Size = UDim2.new(1, 0, 0, 40)
		game:GetService("CoreGui")["NEXUS Hub"].Level.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["NEXUS Hub"].Level.Position = UDim2.new(0.5, 0, -0.2, 0)
		game:GetService("CoreGui")["NEXUS Hub"].Level.Fragments.TextStrokeTransparency = 1
		
		-- Time
		local F_Text2 = Instance.new("Frame")
		F_Text2.Name = "Text2"
		F_Text2.Parent = game:GetService("CoreGui")["NEXUS Hub"]
		...
		game:GetService("CoreGui")["NEXUS Hub"].Text2.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["NEXUS Hub"].Text2.Fragments.Text = ""
		game:GetService("CoreGui")["NEXUS Hub"].Text2.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["NEXUS Hub"].Text2.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["NEXUS Hub"].Text2.Position = UDim2.new(0.5, 0, -0.1, 0)
		game:GetService("CoreGui")["NEXUS Hub"].Text2.Fragments.TextStrokeTransparency = 1
		...
		game:GetService("CoreGui")["NEXUS Hub"].Text.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["NEXUS Hub"].Text.Fragments.Text = '( '..game.Players.LocalPlayer.Name..' )'
		game:GetService("CoreGui")["NEXUS Hub"].Text.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["NEXUS Hub"].Text.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["NEXUS Hub"].Text.Position = UDim2.new(0.5, 0, 0.14, 0)
		game:GetService("CoreGui")["NEXUS Hub"].Text.Fragments.TextStrokeTransparency = 1
		-- Status
		local F_Text3 = Instance.new("Frame")
		F_Text3.Name = "Text3"
		F_Text3.Parent = game:GetService("CoreGui")["NEXUS Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["NEXUS Hub"].Text3
		game:GetService("CoreGui")["NEXUS Hub"].Text3.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["NEXUS Hub"].Text3.Fragments.Text = 'Status: Farm Level.'
		game:GetService("CoreGui")["NEXUS Hub"].Text3.Fragments.Size = UDim2.new(1, 0, 0, 28)
		game:GetService("CoreGui")["NEXUS Hub"].Text3.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["NEXUS Hub"].Text3.Position = UDim2.new(0.5, 0, 0.22, 0)
		game:GetService("CoreGui")["NEXUS Hub"].Text3.Fragments.TextStrokeTransparency = 1
		-- Item Sanguine Art
		local F_Text5 = Instance.new("Frame")
		F_Text5.Name = "Text5"
		F_Text5.Parent = game:GetService("CoreGui")["NEXUS Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["NEXUS Hub"].Text5
		game:GetService("CoreGui")["NEXUS Hub"].Text5.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["NEXUS Hub"].Text5.Fragments.Text = '...'
		game:GetService("CoreGui")["NEXUS Hub"].Text5.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["NEXUS Hub"].Text5.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["NEXUS Hub"].Text5.Position = UDim2.new(0.5, 0, 0.38, 0)
		game:GetService("CoreGui")["NEXUS Hub"].Text5.Fragments.TextStrokeTransparency = 1
		-- Full Moon
		local F_Text6 = Instance.new("Frame")
		F_Text6.Name = "Text6"
		F_Text6.Parent = game:GetService("CoreGui")["NEXUS Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["NEXUS Hub"].Text6
		game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.TextColor3 = Color3.fromRGB(255,140,0)
		game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
		game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["NEXUS Hub"].Text6.Position = UDim2.new(0.5, 0, -0.03, 0)
		game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.TextStrokeTransparency = 1
		spawn(function()
			while wait(1) do
				pcall(function()
					if Three_World then
						if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
							game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 100% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
							game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
							game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 50% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
							game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 25% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
							game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 15% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						else 
							game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 0% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						end 
						...
						game:GetService("CoreGui")["NEXUS Hub"].Text2.Fragments.Text = tempo
					else
						game:GetService("CoreGui")["NEXUS Hub"].Text6.Fragments.Text = '🌕 0% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						local scripttime=game.Workspace.DistributedGameTime
						local seconds = scripttime%60
		...
		F_Text4.Name = "Text4"
		F_Text4.Parent = game:GetService("CoreGui")["NEXUS Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["NEXUS Hub"].Text4
		game:GetService("CoreGui")["NEXUS Hub"].Text4.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["NEXUS Hub"].Text4.Fragments.Text = '...'
		game:GetService("CoreGui")["NEXUS Hub"].Text4.Fragments.Size = UDim2.new(1, 0, 0, 35)
		game:GetService("CoreGui")["NEXUS Hub"].Text4.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["NEXUS Hub"].Text4.Position = UDim2.new(0.5, 0, 0.47, 0)
		game:GetService("CoreGui")["NEXUS Hub"].Text4.Fragments.TextStrokeTransparency = 1
		...
		game:GetService("UserInputService").InputBegan:Connect(function(input, isTyping)
			if not isTyping then
				if input.KeyCode == Enum.KeyCode.B then
					if togle_up then
						game:GetService("CoreGui")["NEXUS Hub"].Enabled = false
						game.Lighting.ExposureCompensation = 0
						--BlurSwitch.Size = 0
						togle_up = false
					else
						game:GetService("CoreGui")["NEXUS Hub"].Enabled = true
		...
		Uitoggle.Text = "NEXUS Hub Kaitun"
		...
		if game.CoreGui:FindFirstChild('NEXUS Hub C') then
			game.CoreGui:FindFirstChild('NEXUS Hub C'):Destroy()
		end
		local function click(a)
			...
			repeat 
				for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.InventoryContainer.Right.Content.ScrollingFrame.Frame:GetDescendants()) do
					if v.Name == 'Background' and tostring(v.BackgroundColor) == 'Bright red' and not table.find(keep_all_name,v.Parent.ItemName.Text) then 
						v.Parent:Clone().Parent = game:GetService("CoreGui")["NEXUS Hub C"][Folder]
						game:GetService("CoreGui")["NEXUS Hub C"][Folder][v.Parent.Name].Name = v.Parent.ItemName.Text
		...
		-- Switch Hub C
		local NEXUS_Hub = Instance.new("ScreenGui")
		NEXUS.Name = "NEXUS Hub C"
		NEXUS.Parent = game:GetService("CoreGui")
		-- Fruit Inventory Backpack
		local F_FruitB = Instance.new("Frame")
		F_FruitB.Name = "FruitB"
		F_FruitB.Parent = game:GetService("CoreGui")["NEXUS Hub C"]
		...
		uig.Parent = game:GetService("CoreGui")["NEXUS Hub C"].FruitB
		...
		function Set_Status_X(vu)
			game:GetService("CoreGui")["NEXUS Hub"].Text3.Fragments.Text = vu
		end
		--[[
		...
		Notify({
			...
			Title = "NEXUS Hub Kaitun | "..tostring(game.Players.LocalPlayer.Name),
			Duration = 5
		})
		Notify({
		...
		status_pass = Notification.new("message", 'NEXUS Hub Kaitun | ', "Status: ...")
	...
	spawn(function()
		...
		Start_S:AddToggle({
		Name = 'Auto Farm',
		Enabled = _G.NEXUS_Hub_Series_R,
		Callback = function(vu)
			Auto_Farm_Kaitun = vu
		end
		})
		if _G.NEXUS_Hub_Series_R then
			Auto_Farm_Kaitun = true
		end
		...
		while wait(10) do
			pcall(function()
				...
				if ris_text ~= '' then
					...
					game:GetService("CoreGui")["NEXUS Hub"].Text4.Fragments.Text  = ris_text
				end
				local ris_text = ''
				if RGB_H then
					ris_text = 'RGB Aura'
				...
				game:GetService("CoreGui")["NEXUS Hub"].Text5.Fragments.Text = ris_text
				wait(300)
			end)
		end
	end)
